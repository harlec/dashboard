...
export const api = {
  ...
  incidenteDetalle: (id: number) =>
    request<IncidenteDetalle>(`/incidentes/${id}/detalle`),
...
export interface IncidenteItem {
  ...
  detalleEstado?: string; causa?: string
}
...
export interface IncidenteDetalle {
  incidente: IncidenteItem
  causa?: string
  pingWindow: PingHist[]
  enlaceWindow: EnlaceEventoWindow[]
  relacionados: IncidenteItem[]
}
