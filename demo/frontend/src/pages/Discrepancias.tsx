...
// ── Constantes ────────────────────────────────────────────────
const ESTACIONES = ['ALFA', 'BETA', 'GAMMA', 'DELTA', 'EPSILON'] as const
// Colores corporativos ALEATICA (manual de marca, sección "2.7 Colores corporativos")
// — mismos tonos que ya usa el muro NOC. Antes DELTA/EPSILON tenían rosado/morado que no
...
<title>Análisis Sensores DEMO — ${fecha}</title>
<style>
...
<div class="header">
  <div>
    ...
    <div class="sub">Red de Peajes DEMO &mdash; ${fecha}</div>
  </div>
